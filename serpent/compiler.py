...
funtable = [
    ...
    ['sha3bytes', 1, 1, ['SHA3']],
    ['ecverify', 5, 1, ['<4>', 32, 'ADD', 'MLOAD', '<4>','MLOAD', '<3>', '<2>', '<1>', '<0>', 'ECVERIFY']],
    ['ecrecover', 5, 0, ['<3>', '<2>', '<1>', '<0>', 'ECRECOVER', '<4>', 32, 'ADD', 'MSTORE', '<4>', 'MSTORE']],
    ['pub2addr', 1, 1, ['<0>', 32, 'ADD', 'MLOAD', '<0>', 'MLOAD', 'PUB2ADDR']],
    ['sload', 1, 1, ['<0>', 'SLOAD']],
